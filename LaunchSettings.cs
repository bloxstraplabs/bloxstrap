...
namespace Bloxstrap
{
    public class LaunchSettings
    {
        ...
        {
            if (arg.StartsWith("limb20-player-limbrv:"))
            {
            ...
            else if (arg.StartsWith("limb20-studio-limbrv:"))
            {
                RobloxLaunchArgs = ProtocolHandler.ParseUri(arg);

                if (!RobloxLaunchArgs.Contains("-startEvent"))
                    RobloxLaunchArgs += " -startEvent www.limbrv.xyz/robloxQTStudioStartedEvent";
