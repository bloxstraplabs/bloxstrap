...
namespace Bloxstrap
{
    public class Bootstrapper
    {
        ...
        private const string AppSettings =
            ...
            "	<BaseUrl>http://www.limbrv.xyz</BaseUrl>\r\n" +
            "</Settings>\r\n";
        ...
        private async Task StartRoblox()
        {
            ...
            {
                Utilities.ShellExecute("https://www.limbrv.xyz/games");
            ...
            string eventName = _launchMode == LaunchMode.Player ? "www.limbrv.xyz/robloxStartedEvent" : "www.limbrv.xyz/robloxQTStudioStartedEvent";
        ...
        public static void CheckInstall()
        {
            ...
            ProtocolHandler.Register("limb20-player-limbrv", "LimRev", Paths.Application);
            ProtocolHandler.Register("limb20-studio-limbrv", "LimRev", Paths.Application);
        ...
        private void Uninstall()
        {
            ...
            using RegistryKey? bootstrapperKey = Registry.CurrentUser.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Uninstall\limb20-player-limbrv");
            if (bootstrapperKey is null)
            {
                robloxPlayerStillInstalled = false;

                ProtocolHandler.Unregister("roblox");
                ProtocolHandler.Unregister("limb20-player-limbrv");
            }
            else
            {
                ...
                ProtocolHandler.Register("limb20-player-limbrv", "LimRev", bootstrapperLocation);
            }

            using RegistryKey? studioBootstrapperKey = Registry.CurrentUser.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Uninstall\limb20-studio-limbrv");
            if (studioBootstrapperKey is null)
            {
                robloxStudioStillInstalled = false;

                ProtocolHandler.Unregister("limb20-studio-limbrv");
            ...
            else
            {
                ...
                ProtocolHandler.Register("limb20-studio-limbrv", "LimRev", studioLocation);
